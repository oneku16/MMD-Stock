"""
Django settings for mmd_stock project.
...
DEBUG = '1' == environ.get('DEBUG', default='1')
...
WSGI_APPLICATION = 'mmd_stock.wsgi.application'
...
DATABASES = {
    "default": {
        ...
        "PORT": environ.get("SQL_PORT", default="5423"),
    }
}
